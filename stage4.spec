...
# example:
# version_stamp: :read !date +\%Y.\%m
version_stamp: 2019.01
...
profile: /usr/portage/profiles/default/linux/amd64/17.0
...
stage4/use: -* ipv6 socks5 ncurses readline ssl
...
stage4/packages: gentoo-sources cfdisk livecd-tools w3m mutt nfs-utils xfsprogs tmux vim iputils wireless-tools wpa_supplicant
